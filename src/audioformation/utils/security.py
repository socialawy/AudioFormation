...
def validate_path_within(path: Path, root: Path) -> bool:
    ...
    """
    try:
        # Resolve both paths to get their true physical locations.
        # This mitigates symlink attacks where a symlink within the root
        # points to an external, potentially sensitive directory.
        ...
        # Gracefully handle infinite symlink loops or malformed paths.
        return False
